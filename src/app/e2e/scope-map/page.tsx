...
export default function ScopeMapE2EPage() {
  ...
  // ScopeMapView reads the cycle's members from context; the harness has no
  // Clerk org, so it supplies an empty roster (assignee pickers render, with
  // no one to pick).
  return (
    <OrganizationUsersProvider organizationUsers={[]}>
      <ScopeMapView
        {...FIXTURE}
        pitch={pitch}
