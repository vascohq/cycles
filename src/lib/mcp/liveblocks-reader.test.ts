...
describe('resolvePitch', () => {
  const storage = {
    ...
    pitches: [
      { id: 'p1', title: 'Mission Control', stage: 'building' as const, needle: null, frame_problem: '', frame_outcome: '', timebox_start: '', timebox_end: '', emoji: '' },
      { id: 'p2', title: 'Agentic Skills', stage: 'framing' as const, needle: null, frame_problem: '', frame_outcome: '', timebox_start: '', timebox_end: '', emoji: '' },
    ],
    scopes: [],
    tasks: [],
    updates: [],
  ...
  it('resolves a title with special characters via its cleaned slug', () => {
    const storageWithSpecialChars = {
      ...
      pitches: [
        ...storage.pitches,
        { id: 'p3', title: 'Agentic Capabilities (Skills & Tools)', stage: 'building' as const, needle: null, frame_problem: '', frame_outcome: '', timebox_start: '', timebox_end: '', emoji: '' },
      ],
    }
    expect(
